...
[PADO-Pauli](https://github.com/Norma-Q/PADO-Pauli) is a Pauli-propagation surrogate (PPS) engine for parameterized quantum circuits, developed and maintained by Hyunwoo Kim and me at NORMA Inc. Instead of evolving a state vector, it propagates observables through the circuit in the Pauli basis and compiles the result into a reusable tensor program: compile once, then evaluate expectation values and gradients many times at different parameters.
...
The engine powers the surrogate pre-training in SAFE ma-QAOA and the large-scale experiments in our mixed IQP-QCBM work. Version 2.0.0 was released in September 2026 and is accepted as a poster at IEEE Quantum Week 2026 (QCE26).
